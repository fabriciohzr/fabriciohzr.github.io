...
But don't get me wrong, in this example, we are only seeing the **speed** perspective and only that, there may (and certainly will) be lots of different variables that the camera will need to afford for the gameplay experience. The thing I realized while working on that is how important it is for us to **know** what kind of experience we want to provide for players.

That's what I wanted to talk about and understand a bit more today. What do you think about it? Any different opinion on that? Let me know what you think about that :)
